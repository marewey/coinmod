...
public class CoinplatinumItem extends MarkscoinsModElements.ModElement {
	@ObjectHolder("markscoins:coinplatinum")
	public static final Item block = null;
	public CoinplatinumItem(MarkscoinsModElements instance) {
		super(instance, 49);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("1,024PC"));
		}
	}
}
