...
public class BankGUIGui extends MarkscoinsModElements.ModElement {
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 132, 53) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote()) {
				MarkscoinsMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
		...
		if (buttonID == 0) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				BankTransferProcedure.executeProcedure($_dependencies);
			}
		}
	}
		...
		if (slotID == 0 && changeType == 0) {
			{
				...
				BankInputCalcProcedure.executeProcedure($_dependencies);
			}
		}
